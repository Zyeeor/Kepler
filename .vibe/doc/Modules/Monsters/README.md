...
| 暴食-魔猫 | gluttony | `gluttony_new` | 已开发但没资源 | 三槽已按 Canonical 对齐；7张`GL-*`；`GL-X01`/`GL-TG01`已清理；Overfed VFX/复制Skill UI占位；`GL-S03`分类本轮不扩展；§5=AI裁定备忘 | [暴食-魔猫.md](./暴食-魔猫.md) |
| 嫉妒-激光异形 | envy | `envy_new` | 已开发但没资源 | 三槽+Mark+10张`EN-*`已落地；正式VFX多占位；§5=AI裁定备忘 | [嫉妒-激光异形.md](./嫉妒-激光异形.md) |
| 愤怒-链狱冥兽 | wrath | `wrath_new` | 已开发但没资源 | 三槽+6张`WR-*`已落地；模型复用`Wrath(full)`；正式VFX/UI占位；§5=AI裁定备忘 | [愤怒-链狱冥兽.md](./愤怒-链狱冥兽.md) |
| 贪婪-万手藏主 | greed | `greed_new` | 已开发但没资源 | 三槽逻辑已落地；模型复用`Greed（full`；8张`GR-*`；正式VFX/动画占位；§5=AI裁定备忘 | [贪婪-万手藏主.md](./贪婪-万手藏主.md) |
| 色欲-灵念师 | lust | `lust_new` | 已开发但没资源 | 三槽+Anchor+7张`LU-*`已落地；正式VFX/模型占位；§5=AI裁定备忘 | [色欲-灵念师.md](./色欲-灵念师.md) |
...
| 已落地怪 | 傲慢 / 怠惰 / 暴食 / 色欲 / 嫉妒 / 贪婪 / 愤怒（Stage B 逻辑）；均仍有正式资源缺口 |
| 待开发怪 | — |
