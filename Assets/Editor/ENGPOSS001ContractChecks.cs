...
public static class ENGPOSS001ContractChecks
{
    ...
    static void MultipliersRespectCaps()
    {
        ...
        Require(Approximately(PossessionImprintMath.LustLifestealMultiplier(100), 1f), "Lust lifesteal cap is wrong.");
        Require(Approximately(PossessionImprintMath.LustLifestealMultiplier(1000), 1f), "Lust stack cap is not enforced.");
