...
public class UIManager : SceneSingleton<UIManager>
{
    ...
    public void OnReturnToMenuClicked()
    {
        ...
        if (confirmDialog != null)
        {
            ...
            confirmDialog.Show("Return to Menu", "Return to menu? Your current progress will be saved and can be continued from the main menu.", OnReturnToMenuConfirmed, null);
